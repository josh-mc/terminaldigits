...
The package `terminaldigits` implements simulated tests of uniformity and independence for terminal digits. For certain paramters, `terminaldigits` also implements Monte Carlo simulations for type I errors and power for the test of independence. Simulations are run in C++ utilizing Rcpp. 
